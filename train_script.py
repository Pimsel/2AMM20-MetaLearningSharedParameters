...
K = 12  # nr of inner loop iterations
...
wandb.init(project='MetaLearnDataset-testrun7', config={
...
if pretrained:
    ...
    train_model(model, device, dataset_path, K, num_epochs, inner_loss_fn, outer_loss_fn, inner_learning_rate, meta_learning_rate, batch_size, patience, pretrained, shared_params, original_unique_params)

else:
    train_model(model, device, dataset_path, K, num_epochs, inner_loss_fn, outer_loss_fn, inner_learning_rate, meta_learning_rate, batch_size, patience)